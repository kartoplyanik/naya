...
player_image_original = pygame.image.load('rocket.png')  
...
# мяч
#ball_image_original = pygame.image.load('kol.png')  
#ball_image = pygame.transform.scale(ball_image_original, (100, 100))
...
speed = 0
enemy_image_original = pygame.image.load('ufo.png.WEBP')
...
while running:
    ...
    text = font.render(f"Рахунок: {score}", True, (133,140,100))
    text2 = font.render(f"Мій Рахунок: {high_score}", True, (33,122,60))
    text3 = font.render(f"Рівень: {level}", True, (111,99,70))
    text4 = font.render(f"Життя: {lives}", True, (133,122,0))
    text5 = font.render("Зомбі апокаліпсис", True, (255,0,0))
    ...
    #new_rect = ball_image.get_rect(center=ball_rect.center)
    #screen.blit(ball_image, new_rect.topleft)
    # Малюємо кулі
    for bullet in bullets:
    ...
    screen.blit(text3,(10,350))
    screen.blit(text4,(10,300))
    screen.blit(text5,(550,10))
